...
const AccessKind: $AccessKind = $.makeType<$AccessKind>(_.spec, "998b88fc-083a-584b-85bb-372ade248f66", _.syntax.literal);
...
const Cardinality: $Cardinality = $.makeType<$Cardinality>(_.spec, "94abc2f6-2e3e-55fc-8e97-b44ba70a3950", _.syntax.literal);
...
const MigrationGeneratedBy: $MigrationGeneratedBy = $.makeType<$MigrationGeneratedBy>(_.spec, "8fcfde20-139b-5c17-93b9-9a49512b83dc", _.syntax.literal);
...
const OperatorKind: $OperatorKind = $.makeType<$OperatorKind>(_.spec, "e48403f0-7017-5bf5-ab92-22825d9f1090", _.syntax.literal);
...
const ParameterKind: $ParameterKind = $.makeType<$ParameterKind>(_.spec, "8037d84a-de95-5e63-ab76-727112419261", _.syntax.literal);
...
const RewriteKind: $RewriteKind = $.makeType<$RewriteKind>(_.spec, "a06f04aa-88b7-5d9a-b520-b8139fd64d0c", _.syntax.literal);
...
const SourceDeleteAction: $SourceDeleteAction = $.makeType<$SourceDeleteAction>(_.spec, "1c938388-8739-57a7-8095-cc173226ad8e", _.syntax.literal);
...
const TargetDeleteAction: $TargetDeleteAction = $.makeType<$TargetDeleteAction>(_.spec, "6b925c92-5e48-5e6d-96f2-4125d9119b66", _.syntax.literal);
...
const TriggerKind: $TriggerKind = $.makeType<$TriggerKind>(_.spec, "3c6fa29f-8481-59c9-a9bf-ac30ab50be32", _.syntax.literal);
...
const TriggerTiming: $TriggerTiming = $.makeType<$TriggerTiming>(_.spec, "a2c7e6ae-370c-53a7-842c-21e238faf3ee", _.syntax.literal);
...
const TypeModifier: $TypeModifier = $.makeType<$TypeModifier>(_.spec, "67722d75-1145-54b6-af26-94602de09d51", _.syntax.literal);
...
const Volatility: $Volatility = $.makeType<$Volatility>(_.spec, "de5b90f2-6e49-5543-991b-28a156c7867f", _.syntax.literal);
...
type $Object_32faaa35947553cf88fce68ecf1be4d9 = $.ObjectType<"schema::Object", $Object_32faaa35947553cf88fce68ecf1be4d9λShape, null, [
  ..._std.$BaseObject['__exclusives__'],
]>;
const $Object_32faaa35947553cf88fce68ecf1be4d9 = $.makeType<$Object_32faaa35947553cf88fce68ecf1be4d9>(_.spec, "32faaa35-9475-53cf-88fc-e68ecf1be4d9", _.syntax.literal);

const Object_32faaa35947553cf88fce68ecf1be4d9: $.$expr_PathNode<$.TypeSet<$Object_32faaa35947553cf88fce68ecf1be4d9, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Object_32faaa35947553cf88fce68ecf1be4d9, $.Cardinality.Many), null);
...
const $SubclassableObject = $.makeType<$SubclassableObject>(_.spec, "145b7b6f-8fa4-5b14-bcd3-5d6d10dc25da", _.syntax.literal);
...
const $InheritingObject = $.makeType<$InheritingObject>(_.spec, "825a1378-6b30-5f15-82f1-1c92e57691f2", _.syntax.literal);
...
export type $AnnotationSubjectλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
const $AnnotationSubject = $.makeType<$AnnotationSubject>(_.spec, "970b2d83-85d8-5a46-a4e8-337d28abc12e", _.syntax.literal);
...
const $AccessPolicy = $.makeType<$AccessPolicy>(_.spec, "a8462073-0539-5640-9d9d-2db251c0b350", _.syntax.literal);
...
const $Alias = $.makeType<$Alias>(_.spec, "4388400b-e01d-582c-b1da-8161814835a6", _.syntax.literal);
...
const $Annotation = $.makeType<$Annotation>(_.spec, "273b8735-318f-53f6-9297-6f20162c9105", _.syntax.literal);
...
const $Type = $.makeType<$Type>(_.spec, "8e652319-e551-5b5c-a7bd-9591f0ef5303", _.syntax.literal);
...
const $PrimitiveType = $.makeType<$PrimitiveType>(_.spec, "da26fa09-3541-5cba-b93f-d5ba58d25589", _.syntax.literal);
...
const $CollectionType = $.makeType<$CollectionType>(_.spec, "e3a7ccf7-4a20-5151-80b3-5156c9373889", _.syntax.literal);
...
const $ArrayExprAlias = $.makeType<$ArrayExprAlias>(_.spec, "2e55d7f5-18ed-54b4-ade0-ba404dd482d3", _.syntax.literal);
...
const $CallableObject = $.makeType<$CallableObject>(_.spec, "800f2df9-dd86-5681-9e3c-b529af481a9d", _.syntax.literal);
...
export type $VolatilitySubjectλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
const $VolatilitySubject = $.makeType<$VolatilitySubject>(_.spec, "ed8e20ca-f2dc-5626-bccb-05ef9ed65791", _.syntax.literal);
...
const $Cast = $.makeType<$Cast>(_.spec, "2b25c5a4-5ad4-5c4b-b545-574ccac3fd7f", _.syntax.literal);
...
const $ConsistencySubject = $.makeType<$ConsistencySubject>(_.spec, "883ec593-7428-5707-af16-d446e5d8ed28", _.syntax.literal);
...
const $Constraint = $.makeType<$Constraint>(_.spec, "9346c403-6ee6-50b6-81b2-a35551cfab2f", _.syntax.literal);
...
export type $DeltaλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
const $Delta = $.makeType<$Delta>(_.spec, "c974be74-46d8-5848-b2a9-be5eda14f73e", _.syntax.literal);

const Delta: $.$expr_PathNode<$.TypeSet<$Delta, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Delta, $.Cardinality.Many), null);

export type $ExtensionλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
const $Extension = $.makeType<$Extension>(_.spec, "b9c53751-8d28-5077-b1db-a03ea59557ed", _.syntax.literal);
...
const $Function = $.makeType<$Function>(_.spec, "3a60f555-7c03-5287-b4c9-f078692a89ef", _.syntax.literal);
...
export type $FutureBehaviorλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
}>;
type $FutureBehavior = $.ObjectType<"schema::FutureBehavior", $FutureBehaviorλShape, null, [
  ...$Object_32faaa35947553cf88fce68ecf1be4d9['__exclusives__'],
]>;
const $FutureBehavior = $.makeType<$FutureBehavior>(_.spec, "003feed0-dc7d-564e-abb5-93a42ba99d64", _.syntax.literal);
...
const $Global = $.makeType<$Global>(_.spec, "e1294378-bb3d-57e0-81d2-6a19ea088231", _.syntax.literal);
...
const $Index = $.makeType<$Index>(_.spec, "decfa7fb-1f66-5986-be86-fc9b6c268a97", _.syntax.literal);
...
const $Pointer = $.makeType<$Pointer>(_.spec, "57e1c6b1-ce76-5b5b-943f-f01f1e6a16a3", _.syntax.literal);

const Pointer: $.$expr_PathNode<$.TypeSet<$Pointer, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Pointer, $.Cardinality.Many), null);

export type $SourceλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
const $Link = $.makeType<$Link>(_.spec, "98fe77cc-128e-58fe-b87a-1251c3288548", _.syntax.literal);

const Link: $.$expr_PathNode<$.TypeSet<$Link, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Link, $.Cardinality.Many), null);

export type $MigrationλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
const $Migration = $.makeType<$Migration>(_.spec, "31f74b3a-d9b1-5e35-a746-057f44c58e76", _.syntax.literal);
...
export type $ModuleλShape = $.typeutil.flatten<$AnnotationSubjectλShape & $Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
}>;
type $Module = $.ObjectType<"schema::Module", $ModuleλShape, null, [
  ...$AnnotationSubject['__exclusives__'],
  ...$Object_32faaa35947553cf88fce68ecf1be4d9['__exclusives__'],
]>;
const $Module = $.makeType<$Module>(_.spec, "7106039a-ed86-5868-8227-3e2fc5e3e5ec", _.syntax.literal);

const Module: $.$expr_PathNode<$.TypeSet<$Module, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Module, $.Cardinality.Many), null);

export type $MultiRangeλShape = $.typeutil.flatten<$CollectionTypeλShape & {
  "element_type": $.LinkDesc<$Type, $.Cardinality.One, {}, false, false,  false, false>;
}>;
type $MultiRange = $.ObjectType<"schema::MultiRange", $MultiRangeλShape, null, [
  ...$CollectionType['__exclusives__'],
]>;
const $MultiRange = $.makeType<$MultiRange>(_.spec, "800c4a49-db9d-5a39-9cf2-aa213b858616", _.syntax.literal);

const MultiRange: $.$expr_PathNode<$.TypeSet<$MultiRange, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($MultiRange, $.Cardinality.Many), null);

export type $MultiRangeExprAliasλShape = $.typeutil.flatten<$MultiRangeλShape & {
}>;
...
export type $ObjectTypeλShape = $.typeutil.flatten<$SourceλShape & Omit<$ConsistencySubjectλShape, "<subject"> & $InheritingObjectλShape & Omit<$TypeλShape, "<target"> & $AnnotationSubjectλShape & {
  ...
  "<__type__[is HasAddress]": $.LinkDesc<_default.$HasAddress, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is HasTimestamps]": $.LinkDesc<_default.$HasTimestamps, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Company]": $.LinkDesc<_default.$Company, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Event]": $.LinkDesc<_default.$Event, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Organizer]": $.LinkDesc<_default.$Organizer, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is Ticket]": $.LinkDesc<_default.$Ticket, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is User]": $.LinkDesc<_default.$User, $.Cardinality.Many, {}, false, false,  false, false>;
  "<__type__[is companyNews]": $.LinkDesc<_default.$companyNews, $.Cardinality.Many, {}, false, false,  false, false>;
...
const $Operator = $.makeType<$Operator>(_.spec, "e37bd85e-5e2f-5daa-9dd9-d21d419032be", _.syntax.literal);
...
export type $ParameterλShape = $.typeutil.flatten<$Object_32faaa35947553cf88fce68ecf1be4d9λShape & {
...
const $Parameter = $.makeType<$Parameter>(_.spec, "87f7d583-3e3c-507e-9fbb-4bf3b9e5aa24", _.syntax.literal);
...
const $Property = $.makeType<$Property>(_.spec, "a57f48ff-3bb9-5693-a2e1-bf328a2ddbfc", _.syntax.literal);
...
const $PseudoType = $.makeType<$PseudoType>(_.spec, "0875f8c3-7033-5cc4-af04-2b6d80e289e0", _.syntax.literal);
...
const $RangeExprAlias = $.makeType<$RangeExprAlias>(_.spec, "bc63491c-2a88-5353-b5f0-6f2188a4f65d", _.syntax.literal);
...
const $Rewrite = $.makeType<$Rewrite>(_.spec, "d60198c8-ad58-5c4c-b3b6-d520c19f5cef", _.syntax.literal);
...
const $ScalarType = $.makeType<$ScalarType>(_.spec, "d055dd47-3eb9-5a31-9d8f-5e7053bbe11e", _.syntax.literal);
...
const $Trigger = $.makeType<$Trigger>(_.spec, "2b738231-1ef7-59d0-a04c-dae012181a02", _.syntax.literal);
...
const $Tuple = $.makeType<$Tuple>(_.spec, "d88b4a0c-9561-56f4-b0a9-7b24027b4de8", _.syntax.literal);
...
const $TupleElement = $.makeType<$TupleElement>(_.spec, "9cc04b0b-11e0-5670-a8a1-441a323e12fb", _.syntax.literal);
