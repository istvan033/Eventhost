  ...
  <section class="flex items-center justify-center min-h-screen  backdrop-blur">
    <div class="min-h-full w-screen bg-gray-900 sm:p-12">
      <div class="mx-auto max-w-md px-6 py-12 dark:bg-gray-800 border-0 shadow-lg sm:rounded-3xl">
        <h1 class="text-2xl font-bold mb-8 text-center">{data.company?.name}</h1>
          ...
          <div class="relative z-0 w-full mb-5">
            <div class="relative z-0 w-full mb-5">
              <div class="pt-3 pb-2 pl-5 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                <p>{data.company?.organizerCode}</p>
              </div>
            </div>
            <div class="relative z-0 w-full mb-5">
              <div class="pt-3 pb-2 pl-5 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200">
            ...
            <div class="relative z-0 w-full mb-5">
              ...
              <div class="relative z-0 w-full mb-5">
                <div class="relative z-0 w-full mb-5">
                  <div class="pt-3 pb-2 pl-5 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                    <p>{data.company?.addressDetail}</p>
                  </div>
                </div>
              </div>
              <div class="relative z-0 w-full mb-5">
              ...
              <div class="relative z-0 w-full mb-5">
                <div class="pt-3 pb-2 pl-5 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                  <p>{data.company?.facebook}</p>
                </div>
              </div>
              <div class="relative z-0 w-full mb-5">
                <div class="pt-3 pb-2 pl-5 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                  <p>{data.company?.instagram}</p>
                </div>
              </div>
              <div class="relative z-0 w-full mb-5">
                <div class="pt-3 pb-2 pl-5 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                  <p>{data.company?.tiktok}</p>
                </div>
              </div>
              <div class="relative z-0 w-full mb-5">
                <div class="pt-3 pb-2 pl-5 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200">
              ...
              <div class="relative z-0 w-full mb-5">
                <div class="pt-3 pb-2 pl-5 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200">
                  <p>{data.company?.threads}</p>
                </div>
              </div>
              <div class="relative z-0 w-full">
                {#if data.organizer}
                  <a href="/company/{data.company?.id}/update" class="px-6 py-3 mt-3 text-lg text-white transition-all duration-150 ease-linear rounded-lg shadow bg-gray-600 hover:bg-gray-100 hover:text-black hover:shadow-lg focus:outline-none block w-full text-center">Update Company</a>
                {/if}
              </div>
            </div>
          </div>
