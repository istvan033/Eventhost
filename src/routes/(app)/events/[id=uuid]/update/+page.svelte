<script lang="ts">
    ...
    let stringPlaceName = data.event?.placeName as string
    let stringCountry = data.event?.country as string
    let stringDescription = data.event?.description as string
    let stringZipCode = data.event?.zipCode as string
    let stringCity = data.event?.city as string
